...
namespace Sandbox
{
    ...
    public class Read_From_Excel
    {
        ...
        public static void JsonConversation()
        {
            ...
            Excel.Workbook xlWorkbook = xlApp.Workbooks.Open(@"C:\data\inglesGuru\L0103B.xlsx");
           ...
           // string colValue = "";
            ...
            File.WriteAllText(@"C:\data\inglesGuru\L0103B.json", json);
        ...
        public static void JsonQuiz()
        {
            ...
            //Create COM Objects. Create a COM object for everything that is referenced
            Excel.Application xlApp = new Excel.Application();
            Excel.Workbook xlWorkbook = xlApp.Workbooks.Open(@"C:\data\inglesGuru\content.xlsx");
            ...
            for (int i = 1; i <= rowCount; i++)
            {
                ...
                //    if (qz.quizes.Count != 0)
                //    {
                //        qz.quizes[cntQuizes - 1].context = qz.quizes[cntQuizes - 1].context + "</ol>";
                //    }
                ...
                if (option != "")
                {
                    ...
                    var sel = new Sel();
                    sel.choice = (qz.quizes[cntQuizes - 1].selections.Count + 1).ToString();
                ...
                if (answer != "")
                {
                    qz.quizes[cntQuizes - 1].answer = answer;
